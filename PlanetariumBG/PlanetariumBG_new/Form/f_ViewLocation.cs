...
namespace Planetarium
{
    ...
    public class f_ViewLocation : System.Windows.Forms.Form
	{
		...
		{
			location.v_Lat = Convert.ToInt16(l_Lat.Text);
			location.v_Lon = Convert.ToInt16(l_Lon.Text);
			Close();
		}

		private void b_SetAsHome_Click(object sender, System.EventArgs e)
		{
			location.v_HomeLat = Convert.ToInt32(l_Lat.Text);
			location.v_HomeLon = Convert.ToInt32(l_Lon.Text);
